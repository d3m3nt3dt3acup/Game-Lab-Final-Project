...
void get_input(std::string &mv_direction);
...
int main()
{
    ...
    curs_set(0);
    noecho();
    mvprintw(Y_pos, X_pos, "W to move up, A to move west, S to move south, D to move east");
    getch();
    refresh();
    nodelay(stdscr, true);
    while (true)
